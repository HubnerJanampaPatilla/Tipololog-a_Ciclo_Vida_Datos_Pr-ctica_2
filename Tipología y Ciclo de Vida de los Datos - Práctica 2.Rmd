...
plot(df$alcohol,df$quality,col="blue",
     xlab = "Cantidad de Alcohol",
     ylab = "Calidad del vino",
     main = "Calidad del vino en función del Alcohol")

plot(df$volatile.acidity,df$quality,col="blue",
     xlab = "Cantidad de Acidez Volátil",
     ylab = "Calidad del vino",
     main = "Calidad del vino en función de la Acidez Volátil")
```
